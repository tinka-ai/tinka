    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          { type: "ul", items: ["Software personalizat (CRM-uri, aplicații desktop și offline)", "Platforme SaaS și de rezervări/programări online", "Creare și design website-uri profesionale", "Dezvoltare și integrare chatbot-uri AI", "Automatizări business și integrări software", "Conținut și media generate cu AI (dublaj, avatare)", "Platforme de e-learning și cursuri online", "Consultanță digitală și strategie online", "Magazine online și soluții e-commerce", "Optimizare SEO și GEO și marketing digital"] },
        ],
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          { type: "ul", items: ["Индивидуальное ПО (CRM, десктопные и офлайн-приложения)", "SaaS-платформы и системы онлайн-записи", "Создание и дизайн профессиональных сайтов", "Разработка и интеграция AI-чатботов", "Автоматизация бизнеса и интеграции ПО", "AI-контент и медиа (дубляж, аватары)", "Платформы e-learning и онлайн-курсы", "Цифровой консалтинг и онлайн-стратегия", "Интернет-магазины и e-commerce решения", "SEO- и GEO-оптимизация и digital-маркетинг"] },
        ],
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          { type: "ul", items: ["Custom software (CRM systems, desktop and offline apps)", "SaaS platforms and online booking/scheduling systems", "Professional website creation and design", "AI chatbot development and integration", "Business automation and software integrations", "AI-generated content and media (dubbing, avatars)", "E-learning platforms and online courses", "Digital consulting and online strategy", "Online stores and e-commerce solutions", "SEO and GEO optimization and digital marketing"] },
        ],
      },
      {
