    ...
    <main style={{
      ...
      <div style={{ textAlign: "center", marginBottom: 56 }}>
        <div style={{
          ...
          fontSize: ".72rem", fontWeight: 600, letterSpacing: ".15em",
        ...
        <h1 style={{ fontSize: "clamp(2.4rem,6vw,4rem)", fontWeight: 700,
                     lineHeight: 1.1, marginBottom: 16 }}>
          <span style={{ color: "#888", fontWeight: 400 }}>{d.title} </span>
          <span style={{ color: GOLD }}>{d.titleHighlight}</span>
        </h1>
        <p style={{ fontSize: "1.05rem", color: "#666", maxWidth: 520,
